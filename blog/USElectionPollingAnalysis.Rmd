---
date: "2017-04-05"
title: "2016 Election Exit Polling Data Analysis"
showonlyimage: false
draft: false
image: "blog/img/Election.png"
weight: 5
type: "post"
author: "Vincent Zhang"
description: "This is an interesting project I worked on a weekend for the Data For Democracy.org. PART I: Scrape and Analyze the Exit Polling Data"
tags: ["USPolitics", "R", "EDA"]
---

- [Introduction](#introduction)
- [Scraping the Exit-Polling Data from CNN](#scraping-the-exit-polling-data-from-cnn)
...
The scraper function encapsulates the steps to scrape from the webpage and store the data in a `tidy` format. 
```{r eval = FALSE}
...
Here is the glimpse of the nationwide exit polling statistics. It's in a tidy format! There are 55 questions while some questions related to demographics are somewhat duplicated. 
```{r eval = FALSE}
...
It turns out on the CNN website, there are only 28 states with exit-polling data online. Also, it seems most states missing exit-polling data are red states. This makes the nationwide exit-polling statistics less credible. 
```{r eval = FALSE}
...
```
<img src="../img/nodata.JPG" class="img-responsive" style="display: block; margin: auto;" />
...
```
Note that the cleaned and tidy format of exit polling data is also publically available on the Data for Democracy [github](https://github.com/Data4Democracy/election-transparency/tree/master/data-raw) and my [data.world](https://data.world/mrapple/2016-exit-polling-data) profile.
